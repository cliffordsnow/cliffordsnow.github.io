...
<!-- language: lang-js -->
  ...
  */
  ...
  // fetch area “Mount Vernon, Skagit County” to search in<br>
  {{geocodeArea:Mount Vernon, Skagit County}}->.searchArea;<br>
  // gather results<br>
  (<br>
    // query part for: “highway=residential”<br>
<br>
    way["highway"="residential"](area.searchArea);<br>
    way["highway"="primary"](area.searchArea);<br>
    way["highway"="secondary"](area.searchArea);<br>
    way["highway"="road"](area.searchArea);<br>
    way["highway"="tertiary"](area.searchArea);<br>
    way["highway"="tertiary_link"](area.searchArea);<br>
<br>
  );<br>
  // print results<br>
  out body;<br>
